...
<div class="container-fluid">
    <div class="row mx-0 w-100">
        <div class="px-2 py-1 col-5 border m-0 bg-primary bg-opacity-25 aling-middle text-center">Jenis Kendaraan</div>
        <div class="px-2 py-1 col-7 border m-0 bg-primary bg-opacity-25 aling-middle text-center">Harga</div>
        <?php 
