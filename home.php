    ...
    <div class="container">
        <div class="col-lg-12 py-2">
            ...
            <div class="container px-4 px-lg-5 mt-5">
                <h3 class="text-center font-weight-bolder">Selamat Datang <?= $_settings->info('name') ?></h3>
                <hr>
                <div class="row">
                    <?php 
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 py-4">
                        ...
                        <div class="row mx-0 my-2">
                            <div class="col-5 border bg-primary m-0 text-center px-2 py-1">Jenis Kendaraan</div>
                            <div class="col-7 border bg-primary m-0 text-center px-2 py-1">Harga</div>
                            <?php 
